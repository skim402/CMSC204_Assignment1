...
public class PasswordChecker_GFA_Test {
	...
	/**
	 * Test if the password is less than 8 characters long. This test Will NOT throw
	 * a LengthException for second case. Because the pwd is 6 chars long, however
	 * does not meet other req and we are NOT catching them in this test case,
	 * Therefore it will execute assertTrue("Threw some incorrect exception",false);
	 * this line will fail, since it Asserts that you are getting the "Threw some
	 * incorrect exception" and if not it will fail this should fail because you
	 * should be getting your exception's' custom message and not "Threw some
	 * incorrect exception"
	 */
